...
image_dir = 'data-1k/base64Images/' # change path to a directory where you keep inputs
...
for img_path in image_paths:
    try:
        ...
        classifications.append((img_path, labelNames[fig_prediction]))
    except:
...
df = pd.DataFrame([(n, n.split('.ipynb')[0], c) for n, c in classifications], columns=['Name', 'NotebookName', 'Category'])
...
cdf_chart.save('model/summary-1k/generated-cdf.html')
...
chart.save('model/summary-1k/type_of_charts.html')
